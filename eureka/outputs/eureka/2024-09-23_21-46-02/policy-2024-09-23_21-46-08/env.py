...
class QuadcopterGPT(VecTask):
    ...
    def _create_quadcopter_asset(self):
        ...
        root.attrib["model"] = "QuadcopterGPT"
    ...
    def compute_reward(self):
        self.rew_buf[:], self.rew_dict = compute_reward(self.root_positions, self.root_linvels, self.target_height)
