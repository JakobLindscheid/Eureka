...
def compute_reward(dof_pos: torch.Tensor, dof_vel: torch.Tensor) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
    ...
    velocity_temperature: float = 0.2  # Increased sensitivity
    angular_velocity_temperature: float = 0.1  # New penalty for pole's angular velocity
    ...
    # Penalty for large pole angular velocities (to encourage smoother pole movement)
