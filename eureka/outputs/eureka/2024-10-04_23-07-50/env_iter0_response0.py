...
class BallBalanceDS(VecTask):
    ...
    def compute_reward(self):
        self.rew_buf[:], self.rew_dict = compute_reward(self.ball_positions, self.ball_linvels, self.sensor_forces, self.temperature_position, self.temperature_velocity)
